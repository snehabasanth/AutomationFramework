...
public class CreateMultipleOrganisation {
	...
	public void CreateMultipleOrganisation(String ORGANIZATIONNAME) throws IOException, InterruptedException{
	    ...
	    if(organsationheader.contains(ORGANIZATIONNAME))
	...
	{
		return eUtil.readMultipleDataFromExcel("CreateMultipleOrganisation");
	}
